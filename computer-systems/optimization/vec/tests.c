...
int main(void)
{
  ...
  printf("%.2fs to run test_empty (%.2fps per test)\n", time_elapsed, time_elapsed * 1e6);
  ...
  clocks_elapsed = test_end - test_start;
  time_elapsed = clocks_elapsed / CLOCKS_PER_SEC;
  printf("%.2fs to run test_start (%.2fps per test)\n", time_elapsed, time_elapsed * 1e6);
  ...
  clocks_elapsed = test_end - test_start;
  time_elapsed = clocks_elapsed / CLOCKS_PER_SEC;
  printf("%.2fs to run test_longer (%.2fps per test)\n", time_elapsed, time_elapsed * 1e6);
